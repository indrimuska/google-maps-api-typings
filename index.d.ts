declare module '@google/maps' {
    ...
    export interface GoogleMapsClient {
         ...
         */
        directions(query: DirectionsQuery, callback?: ResponseCallback<DirectionsResult>): RequestHandle<DirectionsResult>;
    }
    ...
    export interface DirectionsQuery {
         ...
         * 
         * @default DirectionsTravelMode.Driving
         */
         ...
         * 
         * @default DirectionsTrafficModel.BestGuess
         */
        traffic_model?: DirectionsTrafficModel;
        /**
    ...
    export enum DirectionsTrafficModel {
        /**
